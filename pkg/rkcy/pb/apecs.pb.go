...
type MostRecentOffsets struct {
	...
	ProcessGeneration int32 `protobuf:"varint,1,opt,name=process_generation,json=processGeneration,proto3" json:"process_generation,omitempty"`
	ProcessOffset     int64 `protobuf:"varint,2,opt,name=process_offset,json=processOffset,proto3" json:"process_offset,omitempty"`
	StorageGeneration int32 `protobuf:"varint,3,opt,name=storage_generation,json=storageGeneration,proto3" json:"storage_generation,omitempty"`
	StorageOffset     int64 `protobuf:"varint,4,opt,name=storage_offset,json=storageOffset,proto3" json:"storage_offset,omitempty"`
}
...
func (x *MostRecentOffsets) GetProcessGeneration() int32 {
	if x != nil {
...
func (x *MostRecentOffsets) GetProcessOffset() int64 {
	if x != nil {
		return x.ProcessOffset
	}
	return 0
}

func (x *MostRecentOffsets) GetStorageGeneration() int32 {
	if x != nil {
...
func (x *MostRecentOffsets) GetStorageOffset() int64 {
	if x != nil {
...
type ApecsTxn_Step struct {
	...
	Payload       []byte                 `protobuf:"bytes,3,opt,name=payload,proto3" json:"payload,omitempty"`                                  // opaque payload for command
	Status        ApecsTxn_Step_Status   `protobuf:"varint,4,opt,name=status,proto3,enum=rkcy.pb.ApecsTxn_Step_Status" json:"status,omitempty"` // status of this step, all start at pending, and can transition to complete, error, and rolled back
	ProcessedTime *timestamp.Timestamp   `protobuf:"bytes,5,opt,name=processed_time,json=processedTime,proto3" json:"processed_time,omitempty"` // actual time this command result was recorded
	EffectiveTime *timestamp.Timestamp   `protobuf:"bytes,6,opt,name=effective_time,json=effectiveTime,proto3" json:"effective_time,omitempty"` // effective time, useful in some applications as it may make sense to deviate from processed_time for reporting purposes
	Errors        []*ApecsTxn_Step_Error `protobuf:"bytes,7,rep,name=errors,proto3" json:"errors,omitempty"`                                    // general bucket for error messages that will effectively be the logged errors of this step
}
...
var file_apecs_proto_rawDesc = []byte{
	...
	0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc1, 0x05, 0x0a, 0x08, 0x41, 0x70, 0x65, 0x63,
	...
	0x70, 0x73, 0x1a, 0xb5, 0x03, 0x0a, 0x04, 0x53, 0x74, 0x65, 0x70, 0x12, 0x19, 0x0a, 0x08, 0x61,
	...
	0x0c, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x35, 0x0a, 0x06, 0x73, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x72, 0x6b, 0x63,
	0x79, 0x2e, 0x70, 0x62, 0x2e, 0x41, 0x70, 0x65, 0x63, 0x73, 0x54, 0x78, 0x6e, 0x2e, 0x53, 0x74,
	0x65, 0x70, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75,
	...
	0x69, 0x76, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x34, 0x0a, 0x06, 0x65, 0x72, 0x72, 0x6f, 0x72,
	0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x72, 0x6b, 0x63, 0x79, 0x2e, 0x70,
	0x62, 0x2e, 0x41, 0x70, 0x65, 0x63, 0x73, 0x54, 0x78, 0x6e, 0x2e, 0x53, 0x74, 0x65, 0x70, 0x2e,
	0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x06, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x1a, 0x2d, 0x0a,
	...
	,
